...
(function() {
    ...
    var hd = function() {
        ...
        else throw fc("len", b.length), new bc(b.length);
    }, id = function(a, b, c) {
        var d = za(a + "?" + b);
        ...
        if (!(1 <= 100 * Math.random() || ld("?"))) {
            var d = ["t=error", "_e=" + a, "_v=j41d", "sr=1"];
            b && d.push("_f=" + b);
    ...
    var Ob = X("_oot"),
        ...
        ac = [T, U, R, xe, ub, S, vb, Cb, wb, Id, Kb, Lb, Db, Eb, Mb, xb],
        ob = W("transportUrl"),
        De = W("_r", "_r");
    ...
    var Ie = function(a, b, c) {
        ...
        a.fa = !0;
        if (b) {
            if (a.F && jc(b, a.F)) return jc(b, a.F);
    ...
    ad.prototype.send = function(a) {
        ...
        if (1 > arguments.length) O("No hit type specified. Aborting hit.");
            ...
            b ? (c = Yb(bd[b] || [], c), c[Ma] = b, this.a.set(c, void 0, !0), this.filters.H(this.a), L("Send finished: " + (0 == Z.h ? -1 : (new Date).getTime() - Z.h)), this.a.data.u = {}, hf(this.a)) : O("No hit type specified. Aborting hit.")
        }
    };
    var cd = function(a) {
        ...
        for (var b = [], c = 0; c < arguments.length; c++) try {
            ...
            if (d.f) Re.set(d.b[0], d.b[1]), N("Registered new plugin: ga(provide, %s, Function)", d.b[0]);
                ...
                if (d.g) {
                    var e = d,
                        f = e.b[0];
                    if (!t(Re.get(f)) && !Te.get(f)) {
                        Se.hasOwnProperty(f) && F(Se[f]);
                        var ea = e.da;
                        !ea && Se.hasOwnProperty(f) ? (F(39), ea = f + ".js") : F(43);
                        if (ea) {
                            ea && 0 <= ea.indexOf("/") || (ea = ($b || df() ? "https:" : "http:") + "//www.google-analytics.com/plugins/ua/" + ea);
                            var l = Ue(ea),
                                e = void 0;
                            var k = l.protocol,
            ...
            var e = arguments[c],
                Ze = d,
                Xe = Ye;
            ga(e) || t(e) ? ga(e) && !G(e[0]) ? O("First element of command array is not a string: %s", e) : Ze && Ze.g ? O("Invalid require command: %s", e) : O("Command failure: %s", Xe) : O("Command is not an array or function: %s", Xe)
        }
        return b
    };
    jf.R = function(a) {
        try {
            if (a.s) a.s.call(Q, Z.O("t0"));
                ...
                if (a.D) "t0" != a.c ? J('Command ignored. Use "create" instead of "%s.create"', a.c) : Z.create.apply(Z, a.b);
                    ...
                    b.plugins_.get(l) || O("Tracker does not have %s plugin required.", l);
                    Qe = b.plugins_.get(l);
